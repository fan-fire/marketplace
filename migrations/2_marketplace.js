...
const FANIE_WALLET = '0xc073Cf3940C116562FBa21d690FF2121A75844FD';

const erc20Addresses = {
  polygon: {
    'USDC': '0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174',
    'FAN': '0xbC2937E8417944cAea23e22eaC3f4bd8fFe21553'
  },
  mumbai: {
...
module.exports = async (deployer, network, accounts) => {
  ...
  //   await sleep(7500);
  // }
  // // grant fanie's wallet reserver role privs
  // await marketplace.grantRole(web3.utils.soliditySha3('RESERVER_ROLE'), FANIE_WALLET)
};
